...
import com.consulting.mgt.springboot.employee.model.Employee;
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
	...
	@Query("SELECT distinct e FROM Employee e LEFT JOIN FETCH e.desk WHERE UPPER(e.firstName)=UPPER(:firstName)")
	...
	@Query("SELECT distinct e FROM Employee e LEFT JOIN FETCH e.desk WHERE UPPER(e.firstName)=UPPER(:firstName) AND UPPER(e.lastName)=UPPER(:lastName)")
